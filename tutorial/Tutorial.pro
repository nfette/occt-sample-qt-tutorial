...
SAMPLESROOT = $$(CASROOT)/scratch-win/qt
...
LIBS += -LC:\OpenCASCADE6.6.0\ros\win64\vc11\lib \
...
INCLUDEPATH += "C:/Users/nfette/Documents/scratch/qt/SolTraceCloneDLL"

CONFIG(debug,debug|release) {
LIBS += -L"C:/Users/nfette/Documents/scratch/qt/build-SolTraceCloneDLL-Desktop_Qt_5_1_0_MSVC2012_OpenGL_64bit-Debug/debug" \
        -lSolTraceCloneDLL
} else {
LIBS += -L"C:/Users/nfette/Documents/scratch/qt/build-SolTraceCloneDLL-Desktop_Qt_5_1_0_MSVC2012_OpenGL_64bit-Release/release" \
        -lSolTraceCloneDLL
}
